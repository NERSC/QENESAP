...
SUBROUTINE print_clock_pw()
   ...
   IF ( dft_is_hybrid() ) THEN
      ...
      CALL print_clock( 'vexx_init' )
      CALL print_clock( 'vexx_out1' )
      CALL print_clock( 'vexx_g2' )
      CALL print_clock( 'vexx_rho' )
      ...
      CALL print_clock( 'vexx_res' )
      CALL print_clock( 'vexx_qcln' )
      CALL print_clock( 'vexx_out2' )
      CALL print_clock( 'vexx_sum' )
      CALL print_clock( 'sum1' )
      CALL print_clock( 'sum2' )
      CALL print_clock( 'vexx_hpsi' )
      CALL print_clock( 'vexx_nloc' )
      CALL print_clock( 'vexx_deal' )
      CALL print_clock( 'conv_evc' )
      CALL print_clock( 'init_exxp' )
      CALL print_clock( 'start_exxp' )
      CALL print_clock( 'end_exxp' )
      CALL print_clock( 'comm1' )
      CALL print_clock( 'comm2' )
      CALL print_clock( 'comm3' )
      CALL print_clock( 'comm_buff' )
      CALL print_clock( 'cds' )
      CALL print_clock( 'exxenergy' )
	  CALL print_clock( 'exxenergy_rho' )
	  CALL print_clock( 'exxenergy_ffft' )
	  CALL print_clock( 'exxenergy_vc' )
      CALL print_clock( 'energy_init' )
      CALL print_clock( 'energy_ikk1' )
      CALL print_clock( 'energy_j' )
      CALL print_clock( 'energy_deal' )
      IF( okvan) THEN
