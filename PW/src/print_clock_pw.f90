...
SUBROUTINE print_clock_pw()
   ...
   IF ( dft_is_hybrid() ) THEN
      ...
      CALL print_clock( 'sum3' )
      CALL print_clock( 'sum4' )
      CALL print_clock( 'sum5' )
      ...
      CALL print_clock( 'cds_fft' )
      CALL print_clock( 'cds_ggn' )
      CALL print_clock( 'cds_npw' )
      CALL print_clock( 'cds_igk' )
      CALL print_clock( 'cds_ngl' )
