...
#define   __CONF_CFLAGS         "-mcmodel=medium"
#define   __CONF_DFLAGS         " -D__INTEL -D__DFTI -D__MPI -D__PARA -D__ELPA  -D__OPENMP -D__NON_BLOCKING_SCATTER"
#define   __CONF_CPP            "cpp"
#define   __CONF_CPPFLAGS       "-P -C -traditional"

#define   __CONF_F90            "mpiifort"
